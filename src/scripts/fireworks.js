...
((c, u) => {
            ...
            e.reduce(
                (t, i) => (
                    Object.keys(i).forEach((s) => {
                        b.includes(s) ||
                            (Array.isArray(t[s]) && Array.isArray(i[s])
                                ? (t[s] = i[s])
                                : v(t[s]) && v(i[s])
                                  ? (t[s] = w(t[s], i[s]))
                                  : (t[s] = i[s]));
    ...
    class O {
        ...
        constructor({
            ...
            for (
                this.x = t,
                    ...
                    this.flickering = d,
                    this.lineWidth = x,
                    this.explosionLength = m,
                    this.angle = p(0, Math.PI * 2),
                    this.speed = o(1, 10),
                    this.brightness = o(l.min, l.max),
                    this.decay = p(h.min, h.max);
        ...
        draw() {
            ...
            this.ctx.beginPath(),
                ...
                (this.ctx.fillStyle = f(this.hue, this.brightness, this.alpha)),
                this.ctx.moveTo(this.coordinates[t][0], this.coordinates[t][1]),
                this.ctx.lineTo(this.x, this.y),
                (this.ctx.strokeStyle = f(
                    this.hue,
                    this.flickering ? p(0, this.brightness) : this.brightness,
                    this.alpha,
                )),
                this.ctx.stroke();
        }
    ...
    class E {
        ...
        usePointer(t, i) {
            ...
            (s || n) &&
                ((this.x = t.pageX - this.canvas.offsetLeft),
    ...
    class M {
        ...
        constructor() {
            (this.autoresize = !0),
                ...
                (this.mouse = { click: !1, move: !1, max: 1 }),
            ...
            const t = 1e3 / this.fps,
                i = (s) => {
                    ...
                    n >= t - this.tolerance &&
                        ...
                        (this.now = s - (n % t)),
                        (this.tick +=
                            (n * (this.options.intensity * Math.PI)) / 1e3));
                };
            this.rafId = requestAnimationFrame(i);
        }
        unmount() {
    ...
    class C {
        ...
        constructor({
            ...
            for (
                this.x = t,
                    ...
                    this.traceLength = l,
                    this.acceleration = d,
                    this.totalDistance = g(t, i, s, n),
                    this.angle = Math.atan2(n - i, s - t),
                    this.brightness = o(50, 70);
                this.traceLength--;
            )
                this.coordinates.push([t, i]);
        }
        ...
        draw() {
            ...
            this.ctx.beginPath(),
                this.ctx.moveTo(this.coordinates[t][0], this.coordinates[t][1]),
                this.ctx.lineTo(this.x, this.y),
                (this.ctx.strokeStyle = f(this.hue, this.brightness)),
                this.ctx.stroke();
        }
    }
    class y {
        ...
        constructor(t, i = {}) {
            (this.target = t),
                ...
                (this.sound = new T(this.opts)),
                (this.resize = new L(
                    this.opts,
                    this.updateSize.bind(this),
                    this.container,
                )),
                (this.mouse = new E(this.opts, this.canvas)),
                (this.raf = new z(this.opts, this.render.bind(this)));
        }
        get isRunning() {
            return this.running;
        }
        ...
        start() {
            this.running ||
                (this.canvas.isConnected || this.createCanvas(this.target),
                (this.running = !0),
                this.resize.mount(),
                this.mouse.mount(),
                this.raf.mount());
                    ...
                    (this.waitStopRaf = () => {
                        this.waitStopRaf &&
                            ...
                            !this.traces.length &&
                                ...
                                ((this.waitStopRaf = null), this.stop(t), i()));
                    }),
                        this.waitStopRaf();
                });
        }
        ...
        createCanvas(t) {
            t instanceof HTMLCanvasElement
                ? (t.isConnected || document.body.append(t), (this.canvas = t))
        ...
        render() {
            ...
            (this.ctx.globalCompositeOperation = "destination-out"),
                ...
                (this.ctx.lineWidth = p(s.trace.min, s.trace.max)),
                this.initTrace(),
                this.drawTrace(),
                this.drawExplosion();
        }
        createTrace() {
            ...
            this.traces.push(
                new C({
                    ...
                    y: this.height,
                    dx:
                        (this.mouse.x && r.move) || this.mouse.active
                            ? this.mouse.x
                            : o(s.x, s.width - s.x * 2),
                    dy:
                        (this.mouse.y && r.move) || this.mouse.active
                            ? this.mouse.y
                            : o(s.y, s.height * 0.5),
                    ctx: this.ctx,
                    hue: o(t.min, t.max),
        ...
        initTrace() {
            ...
            (this.raf.tick > o(t.min, t.max) ||
                (this.mouse.active && i.max > this.traces.length)) &&
                (this.createTrace(), (this.raf.tick = 0));
        }
        drawTrace() {
            let t = this.traces.length;
            for (; t--; )
                this.traces[t].draw(),
                    this.traces[t].update((i, s, n) => {
                        this.initExplosion(i, s, n),
                            this.sound.play(),
            ...
            for (; P--; )
                this.explosions.push(
                    new O({
                        ...
                        lineWidth: p(a.explosion.min, a.explosion.max),
                        explosionLength: u(r),
                        brightness: l,
                        decay: m,
                    }),
